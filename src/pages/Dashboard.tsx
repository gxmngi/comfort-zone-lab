...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    // Simulate real-time comfort level updates every 2 seconds
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          {/* Right Column: Physiological Data */}
          <div className="flex flex-col gap-6">
            <HRVChart data={hrvData} className="h-[280px]" />
            <EDAChart data={edaData} className="h-[280px]" />
          </div>
        </div>
      </div>
    </DashboardLayout>
