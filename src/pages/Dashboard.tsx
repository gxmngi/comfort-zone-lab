      ...
      <div className="space-y-6">
        ...
        <div className="grid lg:grid-cols-[2fr_3fr] gap-6">
          ...
          <div className="flex flex-col gap-6">
            <ComfortStatus level={comfortLevel} className="h-[220px]" />
            <RecommendationsCard comfortLevel={comfortLevel} hasDustAllergy={profile?.dust_allergy ?? false} className="h-[220px]" />
          </div>
          
          {/* Right Column: Physiological Data (wider) */}
          <div className="flex flex-col gap-6">
            <HRVChart data={hrvData} className="h-[220px] overflow-hidden" />
            <EDAChart data={edaData} className="h-[220px] overflow-hidden" />
          </div>
        </div>
      </div>
    </DashboardLayout>
